module lfa_pipe ( input clk,input rst,
    input  [7:0] A, B,
    input        Cin,
    output  reg [7:0] Sum,
    output   reg     Cout
    ...
    assign G2[2] = G0_r1[2] | (P0_r1[2] & G1[1]); 
    assign P2[2] = P0_r1[2] & P1[1];

    assign G2[3] = G1[3] | (P1[3] & G1[1]); 
    assign P2[3] = P1[3] & P1[1];

    assign G2[6] = G0_r1[6] | (P0_r1[6] & G1[5]);
    assign P2[6] = P0_r1[6] & P1[5];
    ...
    assign G3[4] = G0_r1[4] | (P0_r1[4] & G2[3]); 
    assign P3[4] = P0_r1[4] & P2[3];
    ...
    assign C_comb[2] = G2[2] | (P2[2] & Cin_r1);
