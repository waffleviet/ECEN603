...
analyze -format verilog ./src/ksapipe.v
...
report_area > ./reports/ksa_pipearea.txt
report_timing > ./reports/ksa_pipetiming.txt
report_power > ./reports/ksa_pipepower.txt
start_gui
