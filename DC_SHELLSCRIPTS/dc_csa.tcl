...
analyze -format verilog ./src/csa8bit.v

# Elaborate the top-level design
elaborate carrySaveAdder
...
report_area > ./reports/carrySaveAdderarea.txt
report_timing > ./reports/carrySaveAddertiming.txt
report_power > ./reports/carrySaveAdderpower.txt
start_gui
